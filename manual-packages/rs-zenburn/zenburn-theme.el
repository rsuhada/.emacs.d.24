...
;; Remix: RS
;; increased contrast and a few other tweaks
...
(deftheme zenburn "The Zenburn color theme remix")
...
;;;;; isearch
   `(isearch ((t (:foreground ,zenburn-red-4 :weight bold :background ,zenburn-bg-1))))
   `(isearch-fail ((t (:foreground ,zenburn-fg :background ,zenburn-red-4))))
   `(lazy-highlight ((t (:foreground ,zenburn-red-4 :weight bold :background ,zenburn-bg-05))))
...
;;;;; ace-jump
   ...
   `(ace-jump-face-foreground
     ((t (:foreground ,zenburn-red-4 :background ,zenburn-bg :inverse-video nil))))
;;;;; anzu
...
;;;;; org-mode
   ...
   `(org-done ((t (:bold t :strike-through t :weight bold :foreground ,zenburn-green+3))))
   `(org-formula ((t (:foreground ,zenburn-yellow-2))))
   `(org-headline-done ((t (:foreground ,zenburn-green+3 :strike-through t ))))
   `(org-hide ((t (:foreground ,zenburn-bg-1))))
   ;; `(org-level-1 ((t (:foreground ,zenburn-orange))))
   `(org-level-1 ((t (:foreground ,zenburn-yellow))))
   ;; `(org-level-2 ((t (:foreground ,zenburn-green+4))))
   `(org-level-2 ((t (:foreground ,zenburn-orange))))
